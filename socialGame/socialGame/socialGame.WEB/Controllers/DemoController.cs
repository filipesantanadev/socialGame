...
namespace socialGame.WEB.Controllers
{
    public class DemoController : Controller
    {
        ...
        public async Task<IActionResult> Create(IFormFile files)
        {
            ...
            CloudBlobContainer cloudBlobContainer = cloudBlobClient.GetContainerReference("myimages");
        ...
        public async Task<IActionResult> ShowAllBlobs()
        {
            ...
            CloudBlobDirectory dirb = container.GetDirectoryReference("myimages");
        ...
        public async Task<IActionResult> Delete(string blobName)
        {
            ...
            CloudStorageAccount cloudStorageAccount = CloudStorageAccount.Parse(blobstorageconnection);
            CloudBlobClient cloudBlobClient = cloudStorageAccount.CreateCloudBlobClient();
            string strContainerName = "myimages";
